#!/bin/bash
#SBATCH --job-name=ci_lut_fit
#SBATCH --partition=ampere
#SBATCH --account=mli:cider-ml
#SBATCH --gpus=1
#SBATCH --time=01:00:00
#SBATCH --output=ci_tests/ci_lut_fit-%j.out
#SBATCH --error=ci_tests/ci_lut_fit-%j.err

echo "=========================================="
echo "CI Test: LUT Fit"
echo "=========================================="
...
if [ $EXIT_CODE -eq 0 ]; then
    echo "CI TEST PASSED: LUT fit completed successfully"
else
    echo "CI TEST FAILED: LUT fit failed with exit code $EXIT_CODE"
fi
