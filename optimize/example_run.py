...
def main(config):
    ...
    param_fit = ParamFitter(param_list, dataset_sim.get_track_fields(),
                            ...
                            sim_seed_strategy=config.sim_seed_strategy, fwd_only=config.fwd_only)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--fwd_only', default=False, action="store_true", help='Only do forward simulation with initial parameter values and calculate the loss. Store each simulation output in fwd_only mode.')
