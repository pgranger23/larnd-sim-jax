...
def main(config):
    ...
    param_fit = ParamFitter(param_list, dataset_sim.get_track_fields(),
                            ...
                            sim_seed_strategy=config.sim_seed_strategy, adc_norm=config.chamfer_adc_norm, match_z=config.chamfer_match_z)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--chamfer_adc_norm', type=float, required=True, help='ADC normalisation wrt to position (cm)')
